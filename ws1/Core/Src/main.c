...
volatile uint8_t led_reset = IS_NOT_ACTIVE;
volatile uint8_t status = IS_ACTIVE;
volatile int8_t direction = FORWARDS;
volatile uint16_t interval = DEFAULT_INTERVAL;
